...
class RuntimeQueue(Base):
    ...
    runtime_request_id: Mapped[str] = mapped_column(String(36))
    status: Mapped[str] = mapped_column(String(24))
...
class RuntimeInstanceGroup(Base):
    ...
    __table_args__ = (UniqueConstraint("runtime_request_id", name="uq_runtime_group_request"), Index("ix_runtime_group_status", "status"))
...
class RuntimeInstance(Base):
    ...
    __table_args__ = (Index("ix_runtime_instance_student_status", "student_id", "status"), Index("ix_runtime_instance_group", "runtime_group_id"))
...
class RuntimeContainer(Base):
    ...
    __table_args__ = (UniqueConstraint("provider_container_id", name="uq_runtime_provider_container"), Index("ix_runtime_container_instance", "runtime_instance_id"))
    runtime_container_id: Mapped[str] = mapped_column(String(36), primary_key=True)
    runtime_instance_id: Mapped[str] = mapped_column(String(36))
...
class RuntimeNetwork(Base):
    ...
    __table_args__ = (UniqueConstraint("runtime_group_id", "network_key", name="uq_runtime_network_key"),)
...
class RuntimeEvent(Base):
    ...
    __table_args__ = (Index("ix_runtime_event_instance_time", "runtime_instance_id", "occurred_at"),)
    runtime_event_id: Mapped[str] = mapped_column(String(36), primary_key=True)
    runtime_instance_id: Mapped[str | None] = mapped_column(String(36), nullable=True)
    runtime_group_id: Mapped[str | None] = mapped_column(String(36), nullable=True)
